...
Remember this visualization -- what was it about?
...
A) The practice of un-voting -- choosing not to vote

B) How member countries voted in the United Nations

C) How people in countries that are members of the United Nations voted in their own countries

D) What issues in the United Nations were vetoed
...
-   Last time:
    ...
    -   You **cloned** your `ae` repository and started making some updates in your Quarto documents.

    -   You **committed and pushed** your changes back.
...
::: appex
- Go to [Posit Cloud](https://posit.cloud), enter our course space, and open your `ae` project.

- If you haven't already, Pull to download the latest files.

- Open `ae-02-gss-dataviz.qmd` and follow the instructions to complete the application exercise.
:::
