...
## Warm up: Participate  {.smaller}


Suppose you have a dataset `df` with 100 rows and 5 columns: `x1`, `x2`, `x3`, `x4`, and `x5`.  
`x1` is a categorical variable with levels `a` and `b`. You run the following code:
...
-   Center: [The percent of vote received by Trump in the 2024 presidential election from a **typical** congressional district is 50.3%.]{.fragment}
