...
Go to the [course GitHub organization](https://github.com/rcnj-ids-fa25) and clone `ae-YOUR-GITHUB-NAME` repo to [Posit Cloud](https://posit.cloud) in our course workspace.
